class VeganuaryItemsController < ApplicationController
  ...
  private
    ...
    def veganuary_item_params
      params.require(:veganuary_item).permit(:company_name, :company_description, :url, :offer, :addresses, :company_logo, :category, :offer_images1, :offer_images2, :offer_images3, :comment, :checked, :disclaimer1, :published)
    end
end

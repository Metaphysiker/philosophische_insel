...
function Chat(container) {
  this.container = container, this.container_class = "." + container, this.loading_box = container + "_loading_box", this.loading_box_class = "." + this.loading_box, this.waiting_time_for_next_message = 1000, this.start = function () {
...
//# sourceMappingURL=application-14fdcb7765a6fc5ebdda.chunk.js.map
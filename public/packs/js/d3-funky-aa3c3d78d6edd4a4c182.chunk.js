...
function funkyButton(container_name, data) {
  ...
  this.empty_container = function () {
    ...
    svg.append("foreignObject").attr("x", -(cta_width / 2)).attr("y", margin.top) //.attr("width", $("#funky_button1_cta").width())
...
//# sourceMappingURL=d3-funky-aa3c3d78d6edd4a4c182.chunk.js.map
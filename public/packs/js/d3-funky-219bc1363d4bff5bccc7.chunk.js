...
function funkyButton(container_name, data) {
  ...
  this.empty_container = function () {
    ...
    var svg = d3.select(this.container_class).append("svg").attr("width", width + margin.left + margin.right).attr("height", height + margin.top + margin.bottom).append("g").attr("transform", "translate(".concat(width / 2 - cta_width / 2, ", ").concat(margin.top, ")"));
...
//# sourceMappingURL=d3-funky-219bc1363d4bff5bccc7.chunk.js.map
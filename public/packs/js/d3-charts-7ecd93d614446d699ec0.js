...
/*!*******************************************!*\
  !*** ./app/javascript/packs/d3-charts.js ***!
  \*******************************************/
/*! exports provided: AreaChart, HorizontalBarChart */
...
function HorizontalBarChart(container_class, data) {
  ...
  this.get_max_value_of_array_with_hashes = function (data) {
    ...
    console.log(y("Nix")); //Bars

    svg.selectAll("myRect").data(data).join("rect").attr("x", x(0)).attr("y", function (d) {
      return y(d.name);
    }).attr("width", function (d) {
      return x(d.value);
    }).attr("height", y.bandwidth()).attr("fill", "#00c39b");
    svg.selectAll("g").append("g").attr("fill", "black").attr("text-anchor", "end").attr("font-family", "sans-serif").attr("font-size", 50).selectAll("text").data(data).join("text").attr("x", function (d) {
      return x(d.value);
    }).attr("y-b", function (d) {//console.log(d3.axisLeft(y));
    }).attr("y", function (d, i) {
      return y(i) + y.bandwidth() / 2;
    }).attr("dy", "0.35em").attr("dx", -4).text(d.value).call(function (text) {
...
/******/ });
//# sourceMappingURL=d3-charts-7ecd93d614446d699ec0.js.map
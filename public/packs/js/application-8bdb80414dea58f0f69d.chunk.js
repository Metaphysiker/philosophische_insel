...
function Chat(container) {
  this.container = container, this.container_class = "." + container, this.loading_box_class = "." + container + "_loading_box", this.waiting_time_for_next_message = 1000, this.start = function () {
    $(this.container_class).append("start");
  }, this.append_loading_box = function () {
    $(this.container_class).append("\n      <div class=\"".concat(this.loading_box_class, " chat-bg-computer chat-text chat-argument-field\">\n        <div class=\"lds-ellipsis\"><div></div><div></div><div></div><div></div></div>\n      </div>\n    "));
...
//# sourceMappingURL=application-8bdb80414dea58f0f69d.chunk.js.map
...
/*!***********************************************!*\
  !*** ./app/javascript/packs/vegan_cockpit.js ***!
  \***********************************************/
/*! exports provided: MonthlyReview, MonthlyMemberPageReview, MonthlyDonationPageReview, MonthlyMostVisitedPagesReview, MonthlySinglePageReview, MonthlySourceForSinglePageReview, SourceForSinglePageReview */
...
function MonthlyReview(container_class, dateRanges, view_id) {
  this.container_class = container_class, this.dateRanges = dateRanges, this.view_id = view_id, this.table_name = this.container_class + "_table", this.svg_container = this.container_class + "_svg_container", this.date_format_options = {
    ...
    return new Promise(function (outer_promise_resolve, outer_promise_reject) {
      ...
      var _loop = function _loop(_p, _main_index) {
        _p = _p.then(function () {
          return new Promise(function (resolve, reject) {
            gapi.client.request({
              ...
              body: {
                reportRequests: [{
                  viewId: view_id,
                  dateRanges: [dateRanges[_main_index]],
                  metrics: [{
              ...
              for (var i = 0; i < metrics.length; i++) {
                ...
                var date_of_current_row = new Date(dateRanges[_main_index].startDate);
              ...
              if (_main_index + 1 >= dateRanges.length) {
      ...
      for (var _main_index = 0, p = Promise.resolve(); _main_index < dateRanges.length; _main_index++) {
        _loop(p, _main_index);
      } // end of for loop
...
function MonthlyMemberPageReview(container_class, dateRanges, view_id, registrations) {
  this.container_class = container_class, this.dateRanges = dateRanges, this.view_id = view_id, this.registrations = registrations, this.table_name = this.container_class + "_table", this.svg_container = this.container_class + "_svg_container", this.date_format_options = {
    ...
    return new Promise(function (outer_promise_resolve, outer_promise_reject) {
      ...
      var _loop2 = function _loop2(_main_index2, _p3) {
          ...
          return new Promise(function (resolve, reject) {
            gapi.client.request({
              ...
              body: {
                reportRequests: [{
                  viewId: VIEW_ID,
                  dateRanges: [dateRanges[_main_index2]],
                  metrics: [{
                    expression: 'ga:users'
                  }],
              ...
              for (var i = 0; i < metrics.length; i++) {
                var values = metrics[i].values;
                $("." + table_name + " .tbody").append("\n                  <tr>\n                  </tr>\n                  ");
                var date_of_current_row = new Date(dateRanges[_main_index2].startDate);
                $("." + table_name + " tr:last").append("\n                    <td>".concat(date_of_current_row.toLocaleDateString('de-DE', date_format_options), "</td>\n                  "));
              ...
              if (_main_index2 + 1 >= dateRanges.length) {
      ...
      for (var _main_index2 = 0, _p2 = Promise.resolve(); _main_index2 < dateRanges.length; _main_index2++) {
        _loop2(_main_index2, _p2);
      } // end of for loop
...
function MonthlyDonationPageReview(container_class, dateRanges, view_id, donations) {
  this.container_class = container_class, this.dateRanges = dateRanges, this.view_id = view_id, this.donations = donations, this.table_name = this.container_class + "_table", this.svg_container = this.container_class + "_svg_container", this.date_format_options = {
    ...
    return new Promise(function (outer_promise_resolve, outer_promise_reject) {
      ...
      var _loop3 = function _loop3(_main_index3, _p5) {
          ...
          return new Promise(function (resolve, reject) {
            gapi.client.request({
              ...
              body: {
                reportRequests: [{
                  viewId: VIEW_ID,
                  dateRanges: [dateRanges[_main_index3]],
                  metrics: [{
                    expression: 'ga:users'
                  }],
                  "dimensionFilterClauses": [{
              ...
              for (var i = 0; i < metrics.length; i++) {
                var values = metrics[i].values;
                $("." + table_name + " .tbody").append("\n                  <tr>\n                  </tr>\n                  ");
                var date_of_current_row = new Date(dateRanges[_main_index3].startDate);
                $("." + table_name + " tr:last").append("\n                    <td>".concat(date_of_current_row.toLocaleDateString('de-DE', date_format_options), "</td>\n                  "));
              ...
              if (_main_index3 + 1 >= dateRanges.length) {
                var vertical_bar_chart_grouped_two = new d3Charts.VerticalBarChartGroupedTwo("." + svg_container, data);
                vertical_bar_chart_grouped_two.draw_chart();
                outer_promise_resolve("this report is done"); //outer_promise_reject("error");
              }
      ...
      for (var _main_index3 = 0, _p4 = Promise.resolve(); _main_index3 < dateRanges.length; _main_index3++) {
        _loop3(_main_index3, _p4);
      } // end of for loop
...
function MonthlyMostVisitedPagesReview(container_class, dateRanges, view_id) {
  this.container_class = container_class, this.dateRanges = dateRanges, this.view_id = view_id, this.table_name = this.container_class + "_table", this.svg_container = this.container_class + "_svg_container", this.date_format_options = {
    ...
    return new Promise(function (outer_promise_resolve, outer_promise_reject) {
      ...
      var _loop4 = function _loop4(_main_index4, _p7) {
          ...
          return new Promise(function (resolve, reject) {
            gapi.client.request({
              ...
              body: {
                reportRequests: [{
                  viewId: VIEW_ID,
                  dateRanges: [dateRanges[_main_index4]],
                  "metrics": [{
                    "expression": "ga:users"
                  }],
                  "dimensions": [{
              ...
              var table_name_with_index = table_name + "_" + _main_index4;
              var date_of_current_row = new Date(dateRanges[_main_index4].startDate);
              ...
              $("." + container_class).append("\n                <h2>".concat(date_of_current_row.toLocaleDateString('de-DE', options), "</h2>\n                <table class=\"table ").concat(table_name_with_index, "\">\n                  <tbody class=\"tbody\">\n\n                  </tbody>\n                </table>\n                "));
              ...
              if (_main_index4 + 1 >= dateRanges.length) {
                outer_promise_resolve("this report is done"); //outer_promise_reject("error");
              }
            }, function (error) {
              outer_promise_reject("error");
      ...
      for (var _main_index4 = 0, _p6 = Promise.resolve(); _main_index4 < dateRanges.length; _main_index4++) {
        _loop4(_main_index4, _p6);
      } // end of for loop
...
function MonthlySinglePageReview(container_class, dateRanges, view_id, page_name) {
  this.container_class = container_class, this.dateRanges = dateRanges, this.view_id = view_id, this.page_name = page_name, this.table_name = this.container_class + "_table", this.svg_container = this.container_class + "_svg_container", this.date_format_options = {
    ...
    return new Promise(function (outer_promise_resolve, outer_promise_reject) {
      ...
      var _loop5 = function _loop5(_main_index5, _p9) {
          ...
          return new Promise(function (resolve, reject) {
            gapi.client.request({
              ...
              body: {
                reportRequests: [{
                  viewId: VIEW_ID,
                  dateRanges: [dateRanges[_main_index5]],
                  metrics: [{
                    expression: 'ga:pageviews'
                  }, {
                    expression: 'ga:uniquePageviews'
              ...
              for (var i = 0; i < metrics.length; i++) {
                var values = metrics[i].values;
                $("." + table_name + " .tbody").append("\n                  <tr>\n                  </tr>\n                  ");
                var date_of_current_row = new Date(dateRanges[_main_index5].startDate);
                $("." + table_name + " tr:last").append("\n                    <td>".concat(date_of_current_row.toLocaleDateString('de-DE', date_format_options), "</td>\n                  "));
              ...
              if (_main_index5 + 1 >= dateRanges.length) {
      ...
      for (var _main_index5 = 0, _p8 = Promise.resolve(); _main_index5 < dateRanges.length; _main_index5++) {
        _loop5(_main_index5, _p8);
      } // end of for loop
...
function MonthlySourceForSinglePageReview(container_class, dateRanges, view_id, page_name) {
  this.container_class = container_class, this.dateRanges = dateRanges, this.view_id = view_id, this.page_name = page_name, this.table_name = this.container_class + "_table", this.svg_container = this.container_class + "_svg_container", this.date_format_options = {
    ...
    return new Promise(function (outer_promise_resolve, outer_promise_reject) {
      ...
      var _loop6 = function _loop6(_main_index6, _p11) {
          ...
          return new Promise(function (resolve, reject) {
            gapi.client.request({
              ...
              body: {
                reportRequests: [{
                  viewId: VIEW_ID,
                  dateRanges: [dateRanges[_main_index6]],
                  dimensions: [{
                    name: "ga:source"
                  }],
                  metrics: [{
              ...
              $("." + container_class).append("\n                  <div class=\"".concat(container_class + "_" + "svg_container_" + _main_index6, "\">\n\n                  </div>\n                  "));
              var horizontal_bar_chart = new d3Charts.HorizontalBarChart("." + container_class + "_" + "svg_container_" + _main_index6, data_of_sources);
              horizontal_bar_chart.draw_chart();
              resolve("done");

              if (_main_index6 + 1 >= dateRanges.length) {
                outer_promise_resolve("this report is done"); //outer_promise_reject("error");
              }
            }, function (error) {
              outer_promise_reject("error");
      ...
      for (var _main_index6 = 0, _p10 = Promise.resolve(); _main_index6 < dateRanges.length; _main_index6++) {
        _loop6(_main_index6, _p10);
      } // end of for loop
...
/******/ });
//# sourceMappingURL=vegan_cockpit-eaeb0a78f325f2a96ef3.js.map
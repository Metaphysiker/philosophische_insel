...
function HorizontalBarChart(container_class, data) {
  ...
  this.get_max_value_of_array_with_hashes = function (data) {
    ...
    svg.append("g").attr("fill", "black").attr("text-anchor", "end").attr("font-family", "sans-serif").attr("font-size", 50).selectAll("text").data(data).join("text").attr("x", function (d) {
      return x(d.value);
    }).attr("y-b", function (d) {
...
/******/ });
//# sourceMappingURL=d3-charts-35afaa6b337d2ddd8d21.js.map
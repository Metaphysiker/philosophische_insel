...
function HorizontalBarChart(container_class, data) {
  ...
  this.get_max_value_of_array_with_hashes = function (data) {
    ...
    var height = this.data.length * 100 + 200 - margin.top - margin.bottom; //var height = 500 - margin.top - margin.bottom;
...
/******/ });
//# sourceMappingURL=d3-charts-73f90871f927280eb87e.js.map
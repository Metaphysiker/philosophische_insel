...
function DonutChart(container_class, data) {
  ...
  this.draw_chart = function () {
    ...
    console.log(pie);
    var data_ready = pie(Object.entries(this.data)); // The radius of the pieplot is half the width or half the height (smallest one). I subtract a bit of margin.
...
/******/ });
//# sourceMappingURL=d3-charts-5e5af050080655eb05fb.js.map
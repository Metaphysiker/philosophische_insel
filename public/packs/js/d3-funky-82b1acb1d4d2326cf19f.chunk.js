...
function funkyButton(container_name, data) {
  ...
  this.empty_container = function () {
    ...
    console.log(document.getElementById("funky_button1_cta"));
    var height = document.getElementById("funky_button1_cta").getBoundingClientRect().height; // append the svg object to the body of the page
...
//# sourceMappingURL=d3-funky-82b1acb1d4d2326cf19f.chunk.js.map
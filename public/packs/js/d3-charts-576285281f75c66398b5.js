...
function HorizontalBarChart(container_class, data) {
  ...
  this.get_max_value_of_array_with_hashes = function (data) {
    ...
    svg.append("g").attr("fill", "red").attr("text-anchor", "end").attr("font-family", "sans-serif").attr("font-size", fontSize).selectAll("text").data(data).join("text").attr("x", function (d) {
      return x(d.value);
    }).attr("y", function (d, i) {
      ...
      .attr("dx", +4).attr("fill", "red").attr("text-anchor", "start");
    });
  };
}
...
/******/ });
//# sourceMappingURL=d3-charts-576285281f75c66398b5.js.map
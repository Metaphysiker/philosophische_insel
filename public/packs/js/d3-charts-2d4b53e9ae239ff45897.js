...
function HorizontalBarChart(container_class, data) {
  ...
  this.get_max_value_of_array_with_hashes = function (data) {
    ...
    svg.append("g").attr("fill", "red").attr("text-anchor", "end").attr("font-family", "sans-serif").attr("font-size", 50).selectAll("text").data(data).join("text").attr("x", function (d) {
      return x(d.value);
    }).attr("y", function (d, i) {
...
/******/ });
//# sourceMappingURL=d3-charts-2d4b53e9ae239ff45897.js.map
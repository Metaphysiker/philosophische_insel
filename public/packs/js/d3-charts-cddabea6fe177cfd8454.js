...
function HorizontalBarChart(container_class, data) {
  ...
  this.get_max_value_of_array_with_hashes = function (data) {
    ...
    svg.append("g").attr("fill", "red").attr("text-anchor", "end").attr("font-family", "sans-serif").attr("font-size", 25).selectAll("text").data(data).join("text").attr("xabx", function (d) {
...
/******/ });
//# sourceMappingURL=d3-charts-cddabea6fe177cfd8454.js.map
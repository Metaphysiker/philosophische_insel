...
function funkyButton(container_name, data) {
  ...
  this.empty_container = function () {
    ...
    svg.append("foreignObject").attr("width", $("#funky_button1_cta").width()).attr("height", $("#funky_button1_cta").height()).append("xhtml:body").style("font", "14px 'Helvetica Neue'").html("<div class=\"text-center\">\n                  <button type=\"button\" class=\"button2\">".concat(this.data.cta, "</button>\n                </div>"));
  };
}
...
//# sourceMappingURL=d3-funky-eaebb172d01b785bb2b6.chunk.js.map
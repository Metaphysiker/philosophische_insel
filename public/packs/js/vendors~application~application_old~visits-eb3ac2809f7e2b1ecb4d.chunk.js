(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["vendors~application~application_old~visits"],{
...
(function (X, L) {
  "object" === ( false ? undefined : _typeof(module)) && module.exports ? (L["default"] = L, module.exports = X.document ? L(X) : L) :  true ? !(__WEBPACK_AMD_DEFINE_RESULT__ = (function () {
    return L(X);
  ...
  L(a, "Core/Utilities.js", [a["Core/Globals.js"]], function (a) {
    ...
    function G(b, d) {
      return !!b && "object" === _typeof(b) && (!d || !y(b));
    }
  ...
  L(a, "Core/Color/Color.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, u) {
    ...
    u = function () {
      ...
      u.prototype.get = function (a) {
        ...
        } else h = q && v(q[0]) ? "rgb" === a || !a && 1 === q[3] ? "rgb(" + q[0] + "," + q[1] + "," + q[2] + ")" : "a" === a ? q[3] : "rgba(" + q.join(",") + ")" : B;
      ...
      u.prototype.brighten = function (a) {
        ...
        if (this.stops) this.stops.forEach(function (h) {
          h.brighten(a);
        });else if (v(a) && 0 !== a) for (B = 0; 3 > B; B++) {
          q[B] += x(255 * a), 0 > q[B] && (q[B] = 0), 255 < q[B] && (q[B] = 255);
        }
        return this;
      };
      ...
      u.prototype.tweenTo = function (a, B) {
        var q = this.rgba,
            h = a.rgba;
        h.length && q && q.length ? (a = 1 !== h[3] || 1 !== q[3], B = (a ? "rgba(" : "rgb(") + Math.round(h[0] + (q[0] - h[0]) * (1 - B)) + "," + Math.round(h[1] + (q[1] - h[1]) * (1 - B)) + "," + Math.round(h[2] + (q[2] - h[2]) * (1 - B)) + (a ? "," + (h[3] + (q[3] - h[3]) * (1 - B)) : "") + ")") : B = a.input || "none";
        return B;
      };
  ...
  L(a, "Core/Time.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, u) {
    ...
    u = function () {
      ...
      w.prototype.dateFormat = function (c, l, e) {
        ...
        q(t, function (b, d) {
          for (; -1 !== c.indexOf("%" + d);) {
            c = c.replace("%" + d, "function" === typeof b ? b.call(n, l) : b);
          }
        });
      ...
      w.prototype.getTimeTicks = function (c, l, t, h) {
        ...
        if (H(l)) {
          ...
          for (k = 1; l < t;) {
            p.push(l), l = b === e.year ? n.makeTime(F + k * g, 0) : b === e.month ? n.makeTime(F, h + k * g) : !r || b !== e.day && b !== e.week ? r && b === e.hour && 1 < g ? n.makeTime(F, h, D, m + k * g) : l + b * g : n.makeTime(F, h, D + k * g * (b === e.day ? 1 : 7)), k++;
          }

          p.push(l);
          b <= e.hour && 1E4 > p.length && p.forEach(function (b) {
            0 === b % 18E5 && "000000000" === n.dateFormat("%H%M%S%L", b) && (d[b] = "day");
          });
        }
        ...
        if (1 !== f && h && a) {
          if (h.length === a.length && 1 > f) for (var e = 0; e < a.length; e++) {
            for (var t = h[e], m = a[e], w = [], n = 0; n < m.length; n++) {
              var l = t[n],
                  J = m[n];
              y(l) && y(J) && ("A" !== m[0] || 4 !== n && 5 !== n) ? w[n] = l + f * (J - l) : w[n] = J;
            }
  ...
  L(a, "Core/Renderer/SVG/SVGElement.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Renderer/HTML/AST.js"], a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Color/Palette.js"], a["Core/Utilities.js"]], function (a, u, E, H, x, y) {
    ...
    a = function () {
      ...
      a.prototype.css = function (b) {
        ...
        if (a) {
          d && (b = p(d, g));
          if (b) if (null === b.width || "auto" === b.width) delete this.textWidth;else if ("text" === k.nodeName.toLowerCase() && b.width) var I = this.textWidth = C(b.width);
          this.styles = b;
      ...
      a.prototype.getBBox = function (d, g) {
        ...
        var P = k.styledMode ? c && a.prototype.getStyle.call(c, "font-size") : r && r.fontSize,
            f;
      ...
      a.prototype.setTextPath = function (b, d) {
        ...
        if (b && d && d.enabled) {
          ...
          if (I) for (Q.setAttribute("y", 0), g(e.dx) && Q.setAttribute("x", -e.dx), b = [].slice.call(Q.childNodes), I = 0; I < b.length; I++) {
            var f = b[I];
            f.nodeType !== Node.TEXT_NODE && "tspan" !== f.nodeName || P.appendChild(f);
          }
          a && l && l.add({
            element: Q
          });
      ...
      a.prototype.shadow = function (b, d, g) {
        ...
        if (!l) this.destroyShadows();else if (!this.shadows) {
          ...
          for (r = 1; r <= l.width; r++) {
            ...
            g && (n(f, "height", Math.max(n(f, "height") - C, 0)), f.cutHeight = C);
    ...
    return function (h) {
      ...
      f.prototype.updateBoxSize = function () {
        var a = this.text.element.style,
            e = {},
            h = this.padding,
            m = this.bBox = y(this.widthSetting) && y(this.heightSetting) && !this.textAlign || !H(this.text.textStr) ? f.emptyBBox : this.text.getBBox();
  ...
  L(a, "Core/Renderer/SVG/Symbols.js", [a["Core/Utilities.js"]], function (a) {
    ...
    return {
      arc: v,
      callout: function callout(a, q, h, f, c) {
        ...
        if (!y(m)) return w;
        a + m >= h ? c > q + t && c < q + f - t ? w.splice(3, 1, ["L", a + h, c - 6], ["L", a + h + 6, c], ["L", a + h, c + 6], ["L", a + h, q + f - e]) : w.splice(3, 1, ["L", a + h, f / 2], ["L", m, c], ["L", a + h, f / 2], ["L", a + h, q + f - e]) : 0 >= a + m ? c > q + t && c < q + f - t ? w.splice(7, 1, ["L", a, c + 6], ["L", a - 6, c], ["L", a, c - 6], ["L", a, q + e]) : w.splice(7, 1, ["L", a, f / 2], ["L", m, c], ["L", a, f / 2], ["L", a, q + e]) : c && c > f && m > a + t && m < a + h - t ? w.splice(5, 1, ["L", m + 6, q + f], ["L", m, q + f + 6], ["L", m - 6, q + f], ["L", a + e, q + f]) : c && 0 > c && m > a + t && m < a + h - t && w.splice(1, 1, ["L", m - 6, q], ["L", m, q - 6], ["L", m + 6, q], ["L", h - e, q]);
        return w;
      },
      circle: function circle(a, q, h, f) {
      ...
      diamond: function diamond(a, q, h, f) {
        return [["M", a + h / 2, q], ["L", a + h, q + f / 2], ["L", a + h / 2, q + f], ["L", a, q + f / 2], ["Z"]];
      },
      rect: E,
      roundedRect: H,
      square: E,
      triangle: function triangle(a, q, h, f) {
        return [["M", a + h / 2, q], ["L", a + h, q + f], ["L", a, q + f], ["Z"]];
      },
      "triangle-down": function triangleDown(a, q, h, f) {
        return [["M", a, q], ["L", a + h, q], ["L", a + h / 2, q + f], ["Z"]];
      }
    };
  });
  L(a, "Core/Renderer/SVG/TextBuilder.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, u, E) {
    var v = u.doc,
        x = u.SVG_NS,
        y = E.attr,
        G = E.isString,
    ...
    return function () {
      ...
      h.prototype.modifyDOM = function () {
        ...
        [].forEach.call(c.element.querySelectorAll("tspan.highcharts-br"), function (f, l) {
          f.nextSibling && f.previousSibling && (0 === l && 1 === f.previousSibling.nodeType && (c.firstLineMetrics = c.renderer.fontMetrics(void 0, f.previousSibling)), y(f, {
        ...
        if (h) {
          var m = function m(f, l) {
            ...
            if (a.ellipsis) n && a.truncate(f, n, void 0, 0, Math.max(0, h - parseInt(a.fontSize || 12, 10)), function (b, d) {
              ...
              for (; w.length;) {
                w.length && !a.noWrap && 0 < d && (n.push(f.textContent || ""), f.textContent = w.join(" ").replace(/- /g, "-")), a.truncate(f, void 0, w, 0 === d ? k || 0 : 0, h, function (b, d) {
    ...
    E = function () {
      ...
      z.prototype.getReferenceURL = function () {
        if ((t || w) && e.getElementsByTagName("base").length) {
          ...
          if (ba) return K.location.href.split("#")[0].replace(/<[^>]*>/g, "").replace(/([\('\)])/g, "\\$1").replace(/ /g, "%20");
        }
  ...
  L(a, "Core/Renderer/HTML/HTMLElement.js", [a["Core/Globals.js"], a["Core/Renderer/SVG/SVGElement.js"], a["Core/Utilities.js"]], function (a, u, E) {
    ...
    return function (a) {
      ...
      m.prototype.setSpanRotation = function (a, c, l) {
        ...
        f && (e[f] = e.transform = "rotate(" + a + "deg)", e[f + (x ? "Origin" : "-origin")] = e.transformOrigin = 100 * c + "% " + l + "px", q(this.element, e));
      };
  ...
  L(a, "Core/Axis/Tick.js", [a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, u, E) {
    ...
    u = function () {
      ...
      m.prototype.createLabel = function (a, e, l) {
        var f = this.axis,
            h = f.chart;
        if (a = G(e) && l.enabled ? h.renderer.text(e, a.x, a.y, l.useHTML).add(f.labelGroup) : null) h.styledMode || a.css(c(l.style)), a.textPxLength = a.getBBox().width;
        return a;
      };
      ...
      m.prototype.renderLabel = function (a, c, e, h) {
        ...
        a = a.y;
        var r = !0;
        d && f(g) && (d.xy = a = this.getLabelPosition(g, a, d, n, k, l, h, b), this.isFirst && !this.isLast && !p.showFirstLabel || this.isLast && !this.isFirst && !p.showLastLabel ? r = !1 : !n || k.step || k.rotation || c || 0 === e || this.handleOverflow(a), b && h % b && (r = !1), r && f(a.y) ? (a.opacity = e, d[this.isNewLabel ? "attr" : "animate"](a), this.isNewLabel = !1) : (d.attr("y", -9999), this.isNewLabel = !0));
      };
  ...
  L(a, "Core/Axis/Axis.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Color/Color.js"], a["Core/Color/Palette.js"], a["Core/DefaultOptions.js"], a["Core/Foundation.js"], a["Core/Globals.js"], a["Core/Utilities.js"], a["Core/Axis/AxisDefaults.js"], a["Core/Axis/Tick.js"]], function (a, u, E, H, x, y, G, B, q) {
    ...
    a = function () {
      ...
      a.prototype.setOptions = function (b) {
        this.options = F(B.defaultXAxisOptions, "yAxis" === this.coll && B.defaultYAxisOptions, [B.defaultTopAxisOptions, B.defaultRightAxisOptions, B.defaultBottomAxisOptions, B.defaultLeftAxisOptions][this.side], F(e[this.coll], b));
      ...
      a.prototype.defaultLabelFormatter = function (b) {
        ...
        var z = a.logarithmic ? Math.abs(d) : a.tickInterval,
            f = l && l.length;
        if (a.categories) var h = "" + this.value;else if (k) h = c.dateFormat(k, d);else if (f && 1E3 <= z) for (; f-- && "undefined" === typeof h;) {
          a = Math.pow(r, f + 1), z >= a && 0 === 10 * d % a && null !== l[f] && 0 !== d && (h = b(d / a, -1) + l[f]);
        }
        ...
        d(this, "getSeriesExtremes", null, function () {
          ...
          b.series.forEach(function (d) {
            if (d.visible || !a.options.chart.ignoreHiddenSeries) {
              ...
              } else if (d = d.applyExtremes(), g(d.dataMin) && (e = d.dataMin, b.dataMin = Math.min(C(b.dataMin, e), e)), g(d.dataMax) && (z = d.dataMax, b.dataMax = Math.max(C(b.dataMax, z), z)), l(r) && (b.threshold = r), !c.softThreshold || b.positiveValuesOnly) b.softThreshold = !1;
            }
          });
        });
      ...
      a.prototype.translate = function (b, a, d, c, k, r) {
        ...
        a ? (b = (b * f + I - z) / c + l, k && (b = e.lin2val(b))) : (k && (b = e.val2lin(b)), b = g(l) ? f * (b - l) * c + I + f * z + (g(r) ? c * r : 0) : void 0);
        return b;
      };
      ...
      a.prototype.getMinorTickPositions = function () {
        ...
        if (k && k / d < this.len / 3) {
          ...
          });else if (this.dateTime && "auto" === this.getMinorTickInterval()) r = r.concat(this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(d), c, g, b.startOfWeek));else for (b = c + (a[0] - c) % d; b <= g && b !== r[0]; b += d) {
            r.push(b);
          }
        }
      ...
      a.prototype.setAxisTranslation = function () {
        ...
        if (k || c || e) {
          ...
          g ? (l = g.minPointOffset, f = g.pointRangePadding) : b.series.forEach(function (a) {
            var d = c ? 1 : k ? C(a.options.pointRange, F, 0) : b.axisPointRange || 0,
      ...
      a.prototype.setTickInterval = function (b) {
        ...
        a.adjustForMinRange();
        !(z || a.axisPointRange || a.stacking && a.stacking.usePercentage || h) && l(a.min) && l(a.max) && (c = a.max - a.min) && (!l(w) && m && (a.min -= c * m), !l(O) && M && (a.max += c * M));
        ...
        p && l(a.dataMin) && (q = q || 0, !l(w) && a.min < q && a.dataMin >= q ? a.min = a.options.minRange ? Math.min(q, a.max - a.minRange) : q : !l(O) && a.max > q && a.dataMax <= q && (a.max = a.options.minRange ? Math.max(q, a.min + a.minRange) : q));
      ...
      a.prototype.setTickPositions = function () {
        ...
        !g && (this.ordinal && this.ordinal.positions || !((this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200)) ? g = this.dateTime ? this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(this.tickInterval, b.units), this.min, this.max, b.startOfWeek, this.ordinal && this.ordinal.positions, this.closestPointRange, !0) : this.logarithmic ? this.logarithmic.getLogTickPositions(this.tickInterval, this.min, this.max) : this.getLinearTickPositions(this.tickInterval, this.min, this.max) : (g = [this.min, this.max], A(19, !1, this.chart)), g.length > this.len && (g = [g[0], g.pop()], g[0] === g[1] && (g.length = 1)), this.tickPositions = g, k && (k = k.apply(this, [this.min, this.max]))) && (this.tickPositions = g = k);
        ...
        }) && (this.min -= .5, this.max += .5), a || k || this.adjustTickAmount());
      ...
      a.prototype.trimTicks = function (b, a, g) {
        ...
        if (!this.isLinked) {
          if (a && -Infinity !== c) this.min = c;else for (; this.min - e > b[0];) {
            b.shift();
          }
          if (g) this.max = k;else for (; this.max + e < b[b.length - 1];) {
            b.pop();
          }
      ...
      a.prototype.adjustTickAmount = function () {
        ...
        if (this.hasData() && g(this.min) && g(this.max)) {
          if (e < c) {
            for (; d.length < c;) {
              d.length % 2 || this.min === r ? d.push(n(d[d.length - 1] + a)) : d.unshift(n(d[0] - a));
            }
          ...
          if (l(k)) {
            for (a = b = d.length; a--;) {
              (3 === k && 1 === a % 2 || 2 >= k && 0 < a && a < b - 1) && d.splice(a, 1);
            }
      ...
      a.prototype.renderUnsquish = function () {
          ...
          if (!D) {
            ...
            for (f = d.length; !e && f--;) {
              ...
              if (n = g[n].label) n.styles && "ellipsis" === n.styles.textOverflow ? n.css({
                ...
                width: l + "px"
              }), n.getBBox().height > this.len / d.length - (F.h - F.f) && (n.specificTextOverflow = "ellipsis");
            }
          }
        }
        ...
        d.forEach(function (b) {
          var a = (b = g[b]) && b.label,
              d = k.width,
              c = {};
          a && (a.attr(h), b.shortenLabel ? b.shortenLabel() : p && !d && "nowrap" !== k.whiteSpace && (p < a.textPxLength || "SPAN" === a.element.tagName) ? (c.width = p + "px", D || (c.textOverflow = a.specificTextOverflow || M), a.css(c)) : a.styles && a.styles.width && !c.width && !d && a.css({
            width: null
      ...
      a.prototype.getOffset = function () {
        ...
        if (!a.axisGroup) {
          var J = function J(a, d, g) {
            return c.g(a).attr({
              zIndex: g
            }).addClass("highcharts-" + b.coll.toLowerCase() + d + " " + (b.isRadial ? "highcharts-radial-axis" + d + " " : "") + (q || "")).add(w);
          };
        ...
        }), a.staggerLines && (A *= a.staggerLines), a.labelOffset = A * (a.opposite ? -1 : 1)) : M(r, function (b, a) {
          b.destroy();
          delete r[a];
        });
      ...
      a.prototype.getLinePath = function (b) {
        ...
        d && (b *= -1);
        return a.renderer.crispLine([["M", c ? this.left : k, c ? g : this.top], ["L", c ? a.chartWidth - this.right : k, c ? g : a.chartHeight - this.bottom]], b);
      };
      ...
      a.prototype.render = function () {
        ...
        if (b.hasData() || e) {
          ...
          C && r.forEach(function (d, g) {
            ...
            0 === g % 2 && d < b.max && A <= b.max + (a.polar ? -n : n) && (D[d] || (D[d] = new y.PlotLineOrBand(b)), O = d + n, D[d].options = {
      ...
      a.prototype.destroy = function (b) {
        ...
        for (var k in a.plotLinesAndBandsGroups) {
          a.plotLinesAndBandsGroups[k] = a.plotLinesAndBandsGroups[k].destroy();
        }
      ...
      a.prototype.drawCrosshair = function (b, a) {
        ...
        if (g && !1 !== (l(a) || !c)) {
          c ? l(a) && (e = C("colorAxis" !== this.coll ? a.crosshairPos : null, this.isXAxis ? a.plotX : this.len - a.plotY)) : e = b && (this.horiz ? b.chartX - this.pos : this.len - b.chartY + this.pos);
      ...
      a.prototype.remove = function (b) {
        for (var a = this.chart, d = this.coll, g = this.series, c = g.length; c--;) {
          g[c] && g[c].remove(!1);
        }
  ...
  L(a, "Core/Axis/PlotLineOrBand.js", [a["Core/Axis/Axis.js"], a["Core/Color/Palette.js"], a["Core/Utilities.js"]], function (a, u, E) {
    var v = E.arrayMax,
        x = E.arrayMin,
        y = E.defined,
      ...
      a.prototype.render = function () {
        ...
        var a = this,
            ...
            W = w.events;
        C = {
          "class": "highcharts-plot-" + (r ? "band " : "line ") + (w.className || "")
        };
        var B = {},
            x = l.chart.renderer,
            z = r ? "bands" : "lines";
  ...
  L(a, "Core/Tooltip.js", [a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Color/Palette.js"], a["Core/Renderer/RendererRegistry.js"], a["Core/Utilities.js"]], function (a, u, E, H, x) {
    var v = a.format,
        G = u.doc,
        B = x.clamp,
        q = x.css,
    ...
    a = function () {
      ...
      a.prototype.getPosition = function (a, c, b) {
        var d = this.chart,
            ...
            m = C ? Math.max(G.body.scrollHeight, G.documentElement.scrollHeight, G.body.offsetHeight, G.documentElement.offsetHeight, G.documentElement.clientHeight) : d.chartHeight,
      ...
      a.prototype.refresh = function (a, c) {
        ...
        if (d.enabled) {
          ...
          if (!1 === a) this.hide();else {
            if (this.split) this.renderSplit(a, k);else if (k = q, h = w, c && b.pointer.isDirectTouch && (k = c.chartX - b.plotLeft, h = c.chartY - b.plotTop), b.polar || !1 === C.options.clip || C.shouldShowTooltip(k, h)) c = this.getLabel(), d.style.width && !m || c.css({
        ...
        a = a.slice(0, k.length + 1).reduce(function (a, g, c) {
          if (!1 !== g && "" !== g) {
            ...
            r || (r = {
              padding: y.padding,
              r: y.borderRadius
            }, K || (r.fill = y.backgroundColor, r["stroke-width"] = y.borderWidth), r = U.label("", 0, 0, y[h ? "headerShape" : "shape"] || "callout", void 0, void 0, y.useHTML).addClass((h ? "highcharts-tooltip-header " : "") + "highcharts-tooltip-box " + p).attr(r).add(P));
            r.isActive = !0;
            r.attr({
              text: g
            });
  ...
  L(a, "Core/Pointer.js", [a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Color/Palette.js"], a["Core/Tooltip.js"], a["Core/Utilities.js"]], function (a, u, E, H, x) {
    ...
    a = function () {
      ...
      a.prototype.pinchTranslateDirection = function (a, c, b, g, e, f, l, h) {
        ...
        J ? (A -= .8 * (A - l[k][0]), "number" === typeof v && (v -= .8 * (v - l[k][1])), c()) : l[k] = [A, v];
        D || (f[k] = w - m, f[p] = I);
        f = D ? 1 / P : P;
        e[p] = I;
        e[k] = b;
      ...
      a.prototype.runPointActions = function (d, c) {
        ...
        this.unDocMouseMove || (this.unDocMouseMove = q(b.container.ownerDocument, "mousemove", function (b) {
      ...
      a.prototype.setDOMEvents = function () {
        ...
        this.eventsToUnbind.push(q(c, "mouseleave", this.onContainerMouseLeave.bind(this)));
  ...
  L(a, "Core/Series/Point.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Animation/AnimationUtilities.js"], a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/DefaultOptions.js"], a["Core/Utilities.js"]], function (a, u, E, H, x, y) {
    var v = u.animObject,
        B = E.format,
        q = x.defaultOptions,
        h = y.addEvent,
      ...
      g.prototype.setState = function (b, d) {
        ...
        if (!(b === this.state && !d || this.selected && "select" !== b || !1 === f.enabled || b && (m || h && !1 === r.enabled) || b && F.states && F.states[b] && !1 === F.states[b].enabled)) {
          ...
          if (this.graphic && !this.hasDummyGraphic) {
            ...
            n && (n[b && this.isInside ? "show" : "hide"](), n.element.point = this);
          }
    ...
    var d = function () {
      ...
      a.prototype.adjustMargins = function (a, d) {
        ...
        g && [/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/].forEach(function (f, k) {
          f.test(g) && !e(a[k]) && (b[q[k]] = Math.max(b[q[k]], b.legend[(k + 1) % 2 ? "legendHeight" : "legendWidth"] + [1, -1, -1, 1][k] * c[k % 2 ? "x" : "y"] + J(c.margin, 12) + d[k] + (b.titleOffset[k] || 0)));
        });
      };
      ...
      a.prototype.handleOverflow = function (a) {
        ...
        l && (f = Math.min(f, l));
        q.length = 0;
        a && 0 < f && a > f && !1 !== p.enabled ? (this.clipHeight = h = Math.max(f - 20 - this.titleHeight - k, 0), this.currentPage = J(this.currentPage, 1), this.fullHeight = a, A.forEach(function (a, b) {
          ...
          b.scroll(-1, t);
        }), this.pager = c.text("", 15, 10).addClass("highcharts-legend-navigation"), d.styledMode || this.pager.css(p.style), this.pager.add(w), this.down = c.symbol("triangle-down", 0, 0, n, n).add(w), N("downTracker").on("click", function () {
          b.scroll(1, t);
  ...
  L(a, "Core/Series/SeriesRegistry.js", [a["Core/Globals.js"], a["Core/DefaultOptions.js"], a["Core/Series/Point.js"], a["Core/Utilities.js"]], function (a, u, E, H) {
  ...
  L(a, "Core/Chart/Chart.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Axis/Axis.js"], a["Core/FormatUtilities.js"], a["Core/Foundation.js"], a["Core/Globals.js"], a["Core/Legend.js"], a["Core/MSPointer.js"], a["Core/DefaultOptions.js"], a["Core/Color/Palette.js"], a["Core/Pointer.js"], a["Core/Renderer/RendererRegistry.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Time.js"], a["Core/Utilities.js"], a["Core/Renderer/HTML/AST.js"]], function (a, u, E, H, x, y, G, B, q, h, f, c, e, t, m) {
    ...
    a = function () {
      ...
      a.prototype.isInsidePlot = function (a, b, d) {
        ...
        !d.ignoreY && a.isInsidePlot && (c = I && (c ? I.xAxis : I.yAxis) || {
          pos: f,
          len: Infinity
      ...
      a.prototype.temporaryDisplay = function (a) {
        var b = this.renderTo;
        if (a) for (; b && b.style;) {
          b.hcOrigStyle && (O(b, b.hcOrigStyle), delete b.hcOrigStyle), b.hcOrigDetached && (p.body.removeChild(b), b.hcOrigDetached = !1), b = b.parentNode;
        } else for (; b && b.style;) {
        ...
        L(this, "pan", {
          ...
          b.forEach(function (b) {
            if (b.options.panningEnabled && !b.options.isInternal) {
              ...
              b.panningState = q;
              b.isOrdinal || (r = p - h, 0 < r && (t += r, h = p), r = t - n, 0 < r && (t = n, h -= r), b.series.length && h !== m.min && t !== m.max && h >= p && t <= n && (b.setExtremes(h, t, !1, !1, {
                trigger: "pan"
  ...
  L(a, "Mixins/LegendSymbol.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, u) {
    ...
    return a.LegendSymbolMixin = {
      ...
      drawLineMarker: function drawLineMarker(a) {
        ...
        this.legendLine = f.path([["M", 0, a], ["L", B, a]]).addClass("highcharts-graph").attr(e).add(c);
  ...
  L(a, "Core/Series/Series.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Foundation.js"], a["Core/Globals.js"], a["Mixins/LegendSymbol.js"], a["Core/DefaultOptions.js"], a["Core/Color/Palette.js"], a["Core/Series/Point.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Renderer/SVG/SVGElement.js"], a["Core/Utilities.js"]], function (a, u, E, H, x, y, G, B, q, h) {
    ...
    a = function () {
      ...
      a.prototype.setData = function (a, b, d, c) {
        ...
        !1 !== c && k && f && !e.cropped && !e.hasGroupedData && e.visible && !e.isSeriesBoosting && (C = this.updateData(a, d));
        ...
        if (!C) {
          ...
          if (m && k > m) {
            if (m = e.getFirstValidPoint(a), S(m)) for (d = 0; d < k; d++) {
              ...
              } else for (w && (A = w.indexOf("x"), v = w.indexOf("y"), A = 0 <= A ? A : 0, v = 0 <= v ? v : 1), d = 0; d < k; d++) {
      ...
      a.prototype.getProcessedData = function (a) {
        ...
        for (k = b.length || 1; --k;) {
          if (c = f ? a(b[k]) - a(b[k - 1]) : b[k] - b[k - 1], 0 < c && ("undefined" === typeof n || c < n)) var n = c;else 0 > c && m && (r(15, !1, this.chart), m = !1);
        }
      ...
      a.prototype.addPoint = function (a, b, d, c, e) {
        ...
        var t = r.x;
        var n = p.length;
        if (this.requireSorting && t < p[n - 1]) for (m = !0; n && p[n - 1] > t;) {
          n--;
        }
  ...
  L(a, "Extensions/ScrollablePlotArea.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Axis/Axis.js"], a["Core/Chart/Chart.js"], a["Core/Series/Series.js"], a["Core/Renderer/RendererRegistry.js"], a["Core/Utilities.js"]], function (a, u, E, H, x, y) {
    ...
    E.prototype.applyFixed = function () {
      ...
      a = this.scrollablePixelsX ? [["M", 0, a], ["L", this.plotLeft - 1, a], ["L", this.plotLeft - 1, e], ["L", 0, e], ["Z"], ["M", w, a], ["L", this.chartWidth, a], ["L", this.chartWidth, e], ["L", w, e], ["Z"]] : this.scrollablePixelsY ? [["M", h, 0], ["L", h, this.plotTop - 1], ["L", m, this.plotTop - 1], ["L", m, 0], ["Z"], ["M", h, n], ["L", h, this.chartHeight], ["L", m, this.chartHeight], ["L", m, n], ["Z"]] : [["M", 0, 0]];
    ...
    x.prototype.setStackedPoints = function (a) {
      ...
      if (e && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
        ...
        for (x = 0; x < p; x++) {
          ...
          "percent" === e ? (C = C ? a : g, r && u[C] && u[C][y] ? (C = u[C][y], z.total = C.total = Math.max(C.total, z.total) + Math.abs(E) || 0) : z.total = q(z.total + (Math.abs(E) || 0))) : "group" === e ? (c(E) && (E = E[0]), null !== E && (z.total = (z.total || 0) + 1)) : z.total = q(z.total + (E || 0));
    ...
    H = function (B) {
      ...
      q.prototype.getGraphPath = function (a, f, c) {
        ...
        a.forEach(function (t, q) {
          ...
          t.isNull && !y(f) && 0 < q ? v = !h.connectNulls : t.isNull && !f ? v = !0 : (0 === q || v ? q = [["M", t.plotX, t.plotY]] : e.getPointSpline ? q = [e.getPointSpline(a, t, q)] : m ? (q = 1 === m ? [["L", k.plotX, d]] : 2 === m ? [["L", (k.plotX + p) / 2, k.plotY], ["L", (k.plotX + p) / 2, d]] : [["L", p, k.plotY]], q.push(["L", p, d])) : q = [["L", p, d]], l.push(t.x), m && (l.push(t.x), 2 === m && l.push(t.x)), n.push.apply(n, q), v = !1);
        });
        n.xMap = l;
  ...
  L(a, "Series/Area/AreaSeries.js", [a["Core/Color/Color.js"], a["Mixins/LegendSymbol.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function (a, u, E, H) {
    var v = this && this.__extends || function () {
  ...
  L(a, "Series/AreaSpline/AreaSplineSeries.js", [a["Series/Area/AreaSeries.js"], a["Series/Spline/SplineSeries.js"], a["Mixins/LegendSymbol.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function (a, u, E, H, x) {
    var v = this && this.__extends || function () {
  ...
  L(a, "Series/Column/ColumnSeries.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Color/Color.js"], a["Core/Globals.js"], a["Mixins/LegendSymbol.js"], a["Core/Color/Palette.js"], a["Core/Series/Series.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function (a, u, E, H, x, y, G, B) {
    ...
    B = function (a) {
      ...
      d.prototype.translate = function () {
        ...
        a.points.forEach(function (b) {
          ...
          b.barX = C;
          b.pointWidth = r;
          b.tooltipPos = d.inverted ? [e(l.len + l.pos - d.plotLeft - g, l.pos - d.plotLeft, l.len + l.pos - d.plotLeft), k.len + k.pos - d.plotTop - C - F / 2, z] : [k.left - d.plotLeft + C + F / 2, e(g + l.pos - d.plotTop, l.pos - d.plotTop, l.len + l.pos - d.plotTop), z];
      ...
      d.prototype.pointAttribs = function (a, d) {
        ...
        d && a && (a = K(b.states[d], a.options.states && a.options.states[d] || {}), d = a.brightness, k = a.color || "undefined" !== typeof d && f(k).brighten(a.brightness).get() || k, l = a[e] || l, h = a[g] || h, c = a.dashStyle || c, p = A(a.opacity, p));
        e = {
          fill: k,
          stroke: l,
          "stroke-width": h,
  ...
  L(a, "Series/Bar/BarSeries.js", [a["Series/Column/ColumnSeries.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function (a, u, E) {
    var v = this && this.__extends || function () {
  ...
  L(a, "Mixins/CenteredSeries.js", [a["Core/Globals.js"], a["Core/Series/Series.js"], a["Core/Utilities.js"]], function (a, u, E) {
    ...
    return a.CenteredSeriesMixin = {
      getCenter: function getCenter() {
        ...
        for (e = 0; 4 > e; ++e) {
          m = a[e], q = 2 > e || 2 === e && /%$/.test(m), a[e] = y(m, [f, c, t, a[2]][e]) + (q ? h : 0);
        }

        a[3] > a[2] && (a[3] = a[2]);
        return a;
      },
      getStartAndEndRadians: function getStartAndEndRadians(a, q) {
        a = v(a) ? a : 0;
  ...
  L(a, "Core/Series/DataLabels.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Color/Palette.js"], a["Core/Series/Series.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function (a, u, E, H, x, y, G) {
    ...
    x.prototype.drawDataLabels = function () {
      ...
      if (m(h) || h.enabled || e._hasPointLabels) {
        var B = e.plotGroup("dataLabelsGroup", "data-labels", A ? "inherit" : "hidden", h.zIndex || 6);
        B.attr({
          opacity: +A
        });
    ...
    x.prototype.alignDataLabel = function (a, c, f, b, g) {
      var d = this,
        ...
        series: d
          ...
          x = this.visible && !1 !== a.visible && (a.series.forceDL || m && !w || u || l(f.inside, !!this.options.stacking) && b && k.isInsidePlot(p, h ? b.x + 1 : b.y + b.height - 1, {
        inverted: h,
        paneCoordinates: !0,
        series: d
      }));
    ...
    }, y.pie.prototype.alignDataLabel = a, y.pie.prototype.verifyDataLabelOverflow = function (a) {
      var c = this.center,
          e = this.options,
          b = e.center,
          g = e.minSize || 80,
    ...
    var v = a.extend,
      ...
      a.prototype.currentOptions = function (a) {
        function c(a, f, h, m) {
          var l;
          G(a, function (a, d) {
            if (!m && -1 < e.collectionsWithUpdate.indexOf(d) && f[d]) for (a = q(a), h[d] = [], l = 0; l < Math.max(a.length, f[d].length); l++) {
...
//# sourceMappingURL=vendors~application~application_old~visits-eb3ac2809f7e2b1ecb4d.chunk.js.map
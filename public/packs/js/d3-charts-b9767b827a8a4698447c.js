...
function HorizontalBarChart(container_class, data) {
  ...
  this.get_max_value_of_array_with_hashes = function (data) {
    ...
    svg.append("g").call(d3.axisLeft(y).tickSize(0)); //Bars

    svg.selectAll("myRect").data(data).join("rect").attr("x", x(0)).attr("y", function (d) {
      return y(d.name);
    }).attr("width", function (d) {
      return x(d.value);
    }).attr("height", y.bandwidth()).attr("fill", "#00c39b"); //add Text to the bars
    ...
    .attr("x", function (d) {
      ...
      .attr("dx", +4).attr("fill", "#2c4959").attr("text-anchor", "start");
    });
  };
}
...
/******/ });
//# sourceMappingURL=d3-charts-b9767b827a8a4698447c.js.map
...
function DonutChart(container_class, data) {
  ...
  this.draw_chart = function () {
    ...
    console.log(pie); // Create dummy data
    ...
    console.log(data_ready); // The radius of the pieplot is half the width or half the height (smallest one). I subtract a bit of margin.

    var radius = Math.min(width, height) / 2; // The arc generator
...
/******/ });
//# sourceMappingURL=d3-charts-eb6d0880963243518a10.js.map
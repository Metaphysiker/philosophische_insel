...
function VerticalBarChart(container_class, data) {
  ...
  this.get_max_value_of_array_with_hashes = function (data) {
    ...
    svg.append("g").attr("transform", "translate(0, 0)").call(d3.axisLeft(y)).selectAll("text").attr("transform", "translate(-10,0)rotate(-45)").style("text-anchor", "end"); // x axis
...
/******/ });
//# sourceMappingURL=d3-charts-1b51429ad25ae06fefa6.js.map
...
/*!*******************************************!*\
  !*** ./app/javascript/packs/d3-charts.js ***!
  \*******************************************/
/*! exports provided: AreaChart, HorizontalBarChart, VerticalBarChart */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AreaChart", function() { return AreaChart; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HorizontalBarChart", function() { return HorizontalBarChart; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VerticalBarChart", function() { return VerticalBarChart; });
function AreaChart(container_class) {
...
function HorizontalBarChart(container_class, data) {
  ...
  this.get_max_value_of_array_with_hashes = function (data) {
    ...
    var height = this.data.length * 100 - margin.top - margin.bottom; // append the svg object to the body of the page
    ...
    svg.append("g").attr("fill", "#2c4959").attr("font-family", "sans-serif").selectAll("text").data(data).join("text") //.attr("x", d => x(d.value))
    .attr("x", function (d) {
      return x(0) + 10;
    }).attr("y", function (d) {
...
function VerticalBarChart(container_class, data) {
  ...
  this.get_max_value_of_array_with_hashes = function (data) {
    ...
    var y = d3.scaleLinear().domain([0, this.get_max_value_of_array_with_hashes(data)]).range([0, width]);
    svg.append("g").attr("transform", "translate(0, ".concat(height, ")")).call(d3.axisLeft(y)).selectAll("text").attr("transform", "translate(-10,0)rotate(-45)").style("text-anchor", "end"); // x axis

    var x = d3.scaleBand().range([0, height]).domain(data.map(function (d) {
      return d.name;
    })).padding(.5);
    svg.append("g").call(d3.axisBottom(x).tickSize(0).tickValues([])); //Bars
...
/******/ });
//# sourceMappingURL=d3-charts-caee5374b36785396900.js.map
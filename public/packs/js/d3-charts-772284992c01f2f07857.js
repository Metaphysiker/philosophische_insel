...
function DonutChart(container_class, data) {
  ...
  this.draw_chart = function () {
    ...
    var data_ready = pie(Object.entries(this.values_of_data()));
    ...
    svg.selectAll('allLabels').data(data_ready).join('text').attr(function (d) {
      return function (d) {
        console.log(d);
      };
    }).text(function (d) {
...
/******/ });
//# sourceMappingURL=d3-charts-772284992c01f2f07857.js.map
...
function HorizontalBarChart(container_class, data) {
  ...
  this.get_max_value_of_array_with_hashes = function (data) {
    ...
    svg.append("g").attr("fill", "black").attr("font-size", 30).selectAll("text").data(data).join("text").attr("x", function (d) {
      return x(d.value);
...
/******/ });
//# sourceMappingURL=d3-charts-a8357b5ae76fa1057ac0.js.map
...
function HorizontalBarChart(container_class, data) {
  ...
  this.get_max_value_of_array_with_hashes = function (data) {
    ...
    svg.append("g").attr("fill", "#2c4959").attr("text-anchor", "end").attr("font-family", "sans-serif").selectAll("text").data(data).join("text") //.attr("x", d => x(d.value))
    .attr("x", function (d) {
      return x(0) + 50;
    }).attr("y", function (d) {
...
/******/ });
//# sourceMappingURL=d3-charts-e8567463aef7c06812fd.js.map
...
function HorizontalBarChart(container_class, data) {
  ...
  this.get_max_value_of_array_with_hashes = function (data) {
    ...
    var height = this.data.length * 100 - margin.top - margin.bottom; //var height = 500 - margin.top - margin.bottom;
...
/******/ });
//# sourceMappingURL=d3-charts-71357e83c0295911c5a7.js.map
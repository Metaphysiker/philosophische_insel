...
function VerticalBarChart(container_class, data) {
  ...
  this.get_max_value_of_array_with_hashes = function (data) {
    ...
    svg.selectAll("myRect").data(data).join("rect").attr("y", y(0) - y(d.value)).attr("adafdfa", function (d) {
      console.log(x(d.name));
      console.log(y(0));
      console.log(y(0));
    }).attr("x", function (d) {
      return x(d.name);
    }).attr("width", 100).attr("height", 100).attr("fill", "#00c39b"); //.attr("width", function(d) { return x(d.x1) - x(d.x0) -1 ; })
...
/******/ });
//# sourceMappingURL=d3-charts-cee16d6fb2ba5d7b2764.js.map
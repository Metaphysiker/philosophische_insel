...
function VerticalBarChart(container_class, data) {
  ...
  this.get_max_value_of_array_with_hashes = function (data) {
    ...
    }).attr("adafdfa", function (d) {
      console.log(x(d.name));
      console.log(y(0));
      console.log(y(0));
    }).attr("x", function (d) {
      return x(d.name);
    }).attr("width", x.bandwidth()).attr("height", 100).attr("fill", "#00c39b"); //.attr("width", function(d) { return x(d.x1) - x(d.x0) -1 ; })
...
/******/ });
//# sourceMappingURL=d3-charts-44d0b6db9c70235d490e.js.map
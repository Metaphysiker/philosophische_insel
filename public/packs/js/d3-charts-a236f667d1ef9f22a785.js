...
function HorizontalBarChart(container_class, data) {
  ...
  this.get_max_value_of_array_with_hashes = function (data) {
    ...
    var width = $(container_class).width() - margin.left - margin.right; //var height = this.data.length * 100 - margin.top - margin.bottom;
...
/******/ });
//# sourceMappingURL=d3-charts-a236f667d1ef9f22a785.js.map
...
function funkyButton(container_class, data) {
  ...
  this.empty_container = function () {
    ...
    var height = document.getElementById(this.container_class + "_cta").getBoundingClientRect().height; // append the svg object to the body of the page
...
//# sourceMappingURL=d3-funky-e58a9f4248d6a742f758.chunk.js.map
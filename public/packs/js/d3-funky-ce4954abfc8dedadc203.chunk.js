...
function funkyButton(container_name, data) {
  ...
  this.empty_container = function () {
    ...
    var cta_height = $("#funky_button1_cta").height();
    console.log($("#funky_button1_cta").width()); // append the svg object to the body of the page
    ...
    svg.append("foreignObject") //.attr("width", $("#funky_button1_cta").width())
    //.attr("height", $("#funky_button1_cta").height())
    .attr("height", cta_height).attr("width", cta_width).append("xhtml:body").style("font", "14px 'Helvetica Neue'").html("<div class=\"text-center\">\n                  <button type=\"button\" class=\"button2\">".concat(this.data.cta, "</button>\n                </div>"));
  };
}
...
//# sourceMappingURL=d3-funky-ce4954abfc8dedadc203.chunk.js.map
...
function DonutChart(container_class, data) {
  ...
  this.draw_chart = function () {
    ...
    var data_keys = Object.keys(this.names_of_data());
    var color = d3.scaleOrdinal().domain(this.names_of_data()).range(d3.schemeDark2);
    console.log(data_keys); // Compute the position of each group on the pie:
...
/******/ });
//# sourceMappingURL=d3-charts-494eee801abae9ab4c7e.js.map
...
/*!*******************************************!*\
  !*** ./app/javascript/packs/d3-charts.js ***!
  \*******************************************/
/*! exports provided: HorizontalBarChart, VerticalBarChart */
...
function VerticalBarChart(container_class, data) {
  ...
  this.get_max_value_of_array_with_hashes = function (data) {
    ...
    svg.append("g").attr("fill", "#2c4959").attr("font-family", "sans-serif").attr("font-size", 12).selectAll("text").data(data).join("text") //.attr("x", d => x(d.value))
    .attr("x", function (d) {
      return x(d.name);
    }).attr("y", function (d) {
      return y(d.value);
    }).attr("dy", -10).attr("dx", 0).text(function (d) {
      return d.value;
    });
  };
}
...
/******/ });
//# sourceMappingURL=d3-charts-39dae1baf35d0944c5b3.js.map
...
function funkyButton(container_name, data) {
  ...
  this.empty_container = function () {
    ...
    .attr("height", 500).attr("width", 500).append("xhtml:body").style("font", "14px 'Helvetica Neue'").html("<div class=\"text-center\">\n                  <button type=\"button\" class=\"button2\">".concat(this.data.cta, "</button>\n                </div>"));
  };
}
...
//# sourceMappingURL=d3-funky-d62f8ccec978774d32fd.chunk.js.map
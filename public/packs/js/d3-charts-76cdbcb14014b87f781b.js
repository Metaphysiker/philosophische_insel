...
function HorizontalBarChart(container_class, data) {
  ...
  this.get_max_value_of_array_with_hashes = function (data) {
    ...
    svg.append("g").attr("fill", "#2c4959").attr("text-anchor", "end").attr("font-family", "sans-serif").selectAll("text").data(data).join("text").attr("x", function (d) {
      return x(d.value);
    }).attr("y", function (d) {
...
/******/ });
//# sourceMappingURL=d3-charts-76cdbcb14014b87f781b.js.map
...
function HorizontalBarChart(container_class, data) {
  ...
  this.get_max_value_of_array_with_hashes = function (data) {
    ...
    svg.append("g").attr("fill", "red").attr("text-anchor", "end").attr("font-family", "sans-serif").attr("font-size", 25).selectAll("text").data(data).join("text").attr("x", function (d) {
      return x(d.value);
    }).attr("y", function (d) {
      ...
      .attr("dx", +4).attr("fill", "yellow").attr("text-anchor", "start");
    });
  };
}
...
/******/ });
//# sourceMappingURL=d3-charts-b1d1258a127d4adb14e5.js.map
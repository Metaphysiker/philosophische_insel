...
function VerticalBarChart(container_class, data) {
  ...
  this.get_max_value_of_array_with_hashes = function (data) {
    ...
    svg.selectAll("myRect").data(data).join("rect").attr("y", y(0)).attr("x", y(0)).attr("width", y.bandwidth()).attr("height", function (d) {
      return x(d.value);
...
/******/ });
//# sourceMappingURL=d3-charts-6b6955d1dab173db4ba8.js.map
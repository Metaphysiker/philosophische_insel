...
class HorsesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create horse" do
    assert_difference('Horse.count') do
      post horses_url, params: { horse: { comment: @horse.comment, name: @horse.name, next_shoeing_date: @horse.next_shoeing_date } }
    end
  ...
  test "should update horse" do
    patch horse_url(@horse), params: { horse: { comment: @horse.comment, name: @horse.name, next_shoeing_date: @horse.next_shoeing_date } }
